...
- Fixed a bug introduced in the last release where placemarks wouldn't update
  after changing floors
- Fixed a bug introduced in the last release where the `loadPlacemarks` toggle
