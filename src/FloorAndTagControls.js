...
const cssTagControl = cssControl;

const cssFloorControl = css(cssControl, {
  marginTop: 10
});
...
const FloorAndTagControls = ({
  ...
  <div className={cssFloorAndTagControls}>
    <button
      className={cx("meridian-tag-control", cssTagControl)}
      onClick={openTagListOverlay}
    >
    ...
    <button
      className={cx("meridian-floor-control", cssFloorControl)}
      onClick={openFloorOverlay}
    >
...
FloorAndTagControls.propTypes = {
  ...
  openFloorOverlay: PropTypes.func.isRequired,
  openTagListOverlay: PropTypes.func.isRequired
};
