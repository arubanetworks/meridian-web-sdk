...
interface FloorAndSearchControlsProps {
  showFloors: boolean;
  showTagList: boolean;
...
const FloorAndSearchControls: FunctionComponent<FloorAndSearchControlsProps> =
  ({ toggleFloorOverlay, toggleTagListOverlay, showFloors, showTagList }) => {
    return (
      <div className={cssFloorAndSearchControls}>
        {showTagList ? (
          <button
            className={cx("meridian-search-control", cssControl)}
...
const cssFloorAndSearchControls = css({
...
export default FloorAndSearchControls;
